  ...
  <div className="container">
    <div className="row gy-4">
      ...
      <div className="col-lg-3 col-md-6">
        <img src="./img/Frame.png" alt="" className="footer-logo" />
    ...
    <div className="row text-center mt-4">
      <div className="col-12 d-flex flex-wrap justify-content-center footer-bottom-icons">
        <img src="./img/kaktus.png" alt="" className='img img-fluid' />
        <img src="./img/2.png" alt="" className='img img-fluid' />
        <img src="./img/qol.png" alt="" className='img img-fluid' />
        <img src="./img/4.png" alt="" className='img img-fluid' />
        <img src="./img/lab.png" alt="" className='img img-fluid' />
        <img src="./img/6.png" alt="" className='img img-fluid' />
      </div>
    </div>
  </div>
</div>
